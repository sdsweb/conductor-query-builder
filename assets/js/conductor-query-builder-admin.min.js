...
var r,o,n,i,s,c,u,a,l,d,p,b,h,y
...
r.length&&!e.hasClass("open")&&o.slideToggle(0)}),i=new conductor_query_builder.Backbone.Views.Query_Builder_Wrapper({type:"query-builder-wrapper",shortcode:e}),conductor_query_builder.Backbone.instances.views.query_builder_wrapper=i},1)},reset:function(e){s.reset(),void 0!==e&&(conductor_query_builder.meta=e),s.render()}},shortcode:{init:function(){d=new conductor_query_builder.Backbone.Collections.Shortcode,conductor_query_builder.Backbone.instances.collections.shortcode.push(d),l=new conductor_query_builder.Backbone.Models.Shortcode,d.add(l),conductor_query_builder.Backbone.instances.models.shortcode.push(l),p=new conductor_query_builder.Backbone.Views.Shortcode({model:l,queries:conductor_query_builder.queries,type:"shortcode"}),conductor_query_builder.Backbone.instances.views.shortcode=p,b=new conductor_query_builder.Backbone.Views.Shortcode_Actions({type:"shortcode-actions",button_type:"insert",label:conductor_query_builder.l10n.shortcode.insert}),conductor_query_builder.Backbone.instances.views.shortcode_actions=b,p.views.set(b.el_selector,b,{silent:!0}),h=new conductor_query_builder.Backbone.Views.Shortcode_Insert({queries:p.options.queries,type:"shortcode-insert"}),conductor_query_builder.Backbone.instances.views.shortcode_insert=h,p.views.set(h.el_selector,h,{silent:!0}),y=new conductor_query_builder.Backbone.Views.Shortcode_Create_Title({type:"shortcode-create-title",title:conductor_query_builder.title||""}),conductor_query_builder.Backbone.instances.views.shortcode_create_title=y,p.views.set(y.el_selector,y,{silent:!0}),p.render()},reset:function(){p.reset(),h.reset()}},conductor:{widget:{reset:function(e){e=e||{}
var r,o=!1,n=[]
...
this.options.shortcode||i.length&&i.data("conductor-query-builder-skip-preview")||i.length&&i.hasClass("select2-search__field")&&i.parents(".select2-container").prev(".conductor-qb-select2").data("conductor-query-builder-skip-preview")||(o.trigger("conductor-query-builder-preview-query",[this,n]),n.addClass(conductor_query_builder.css.classes.loading).html(""),this.ajax.current_request&&this.ajax.current_request.abort(),this.ajax.current_request=e.ajax.post(conductor_query_builder.ajax.preview.action,this.ajax.setupAJAXData(conductor_query_builder.ID,conductor_query_builder.ajax.preview.nonce,conductor_query_builder.ajax.preview.action)).done(this.ajax.success).fail(this.ajax.fail))},400),maybeShowConductorWidgetColumnsSetting:function(e){var r=t(e.currentTarget),o=r.val(),n=conductor.widgets.conductor.displays,i=o&&n&&n[o]&&_.isObject(n[o])?n[o]:!1,s=r.parents(".widget"),c=s.find(".conductor-columns"),u=window.getUserSetting(conductor_query_builder.user.settings["query-builder"].mode.name)
...
r.length||(e=e.replace("_","-"),r=this.$el.find(e)),r.length&&(r.length>1?r.each(function(){var e=t(this),r=e.data("clause-group-type"),o=conductor_query_builder.clauses[r]&&conductor_query_builder.clauses[r].config,n=o&&o.limit?parseInt(o.limit,10):-1,i=u.where({type:r}).length
0===i&&conductor_query_builder.meta[r]&&(i=conductor_query_builder.meta[r].length),(-1===n||n>i)&&e.prop("disabled",!1)}):r.prop("disabled",!1))},disableActionButtons:function(){this.flags.action_buttons_enabled=!1,this.disableActionButton(this.action_button_selector)},disableActionButton:function(e){var t=this.$el.find(e)
...
"query-builder-actions"===e.options.type&&(t=c.map(function(e){return e.cid}).indexOf(e.cid),-1!==t&&c.splice(t,1))}),u.remove(this.model),r=e.Backbone.View.prototype.remove.apply(this,arguments),o=s.map(function(e){return e.cid}).indexOf(this.cid),-1!==o&&s.splice(o,1),-1!==l&&conductor_query_builder.meta[a][l]&&conductor_query_builder.meta[a].splice(l,1),n=s.filter(function(e){return e.options.type===a}),n.length&&_.each(n,function(e){!e.options.flags.removing&&e.options.count>l&&(e.render(!0),e.options.flags.re_rendering=!0,e.options.sub_clause_el_selector&&_.each(e.views.get(e.options.sub_clause_el_selector),function(e){e.render(!0)}),e.options.flags.re_rendering=!1)}),r},select2Change:function(e,r){var o,n,i,s=t(e.currentTarget),c=r.$select2.filter('[data-type="parameters"]'),u=c.find("option"),a=u.filter(":selected"),l=a.data("parameter"),d=a.data("field"),_=r.$select2.filter('[data-type="operators"]'),p=_.find("option"),b=_.val(),h=r.$select2.filter('[data-type="values"]'),y=h.find("option"),f=h.val(),g=s.val(),m=s.data("type"),q=s.data("select-type"),v=this.model.get("columns")
switch(m){case"parameters":if(this.options.flags.re_init_values=!1,o=this.getParameterData(g,l,d,q),n=this.getOperators(o),i=this.getValues(g,q),!(n&&n.length&&_.length&&g))return
this.updateOperatorsSelect(_,p,b,n),_.prop("disabled")&&_.prop("disabled",!1),r.initializeSelect2(["operators"]),v&&v.values&&i&&(this.options.flags.re_init_values=this.updateValuesSelect(h,y,f,i))
break
case"operators":v&&v.values&&(h.prop("disabled")&&conductor_query_builder.operators[g]&&("string"==typeof conductor_query_builder.operators[g]||conductor_query_builder.operators[g].type&&"bool"!==conductor_query_builder.operators[g].type)?h.prop("disabled",!1):!h.prop("disabled")&&conductor_query_builder.operators[g]&&"string"!=typeof conductor_query_builder.operators[g]&&conductor_query_builder.operators[g].type&&"bool"===conductor_query_builder.operators[g].type&&h.prop("disabled",!0))}},getCurrentCount:function(e){e=e||!1
var t
return t=u.where({type:this.options.type}).length,t=e&&0!==t?t-1:t},getParameterData:function(e,t,r,o){var n,i=e&&"string"==typeof e&&conductor_query_builder.parameters[e]?conductor_query_builder.parameters[e]:!1,s=void 0!==conductor_query_builder.parameters[o]
return(!i||s||!i.operators&&t&&o&&(conductor_query_builder.parameters[t]||conductor_query_builder.parameters[o]))&&(i=!i&&conductor_query_builder.parameters[t]?conductor_query_builder.parameters[t]:i,(!i||s||!i.operators&&t!==o&&conductor_query_builder.parameters[o])&&(n=conductor_query_builder.parameters[o]),n&&_.isObject(n)&&!n.operators&&n.fields&&n.fields[r]&&(i=n.fields[r])),i},getOperators:function(e){var t
return t=_.isObject(e)&&e.operators?e.operators:[e],t=_.isObject(t)?_.values(t):t},getValues:function(e,t){var r="string"==typeof e?conductor_query_builder.values[e]:!1
return!r&&t&&conductor_query_builder.values[t]&&(r=conductor_query_builder.values[t],r&&_.isObject(r)&&r.hasOwnProperty(e)&&(r=r[e])),r},updateOperatorsSelect:function(e,r,o,n,i){i=i||!1,r.each(function(){var e=t(this),r=(e.prop("multiple"),e.val())
...
var s=e.val(),c=!1
return _.each(n,function(t,o){var n,i,s
o=_.isObject(t)?o:t,o=_.isObject(t)&&t.hasOwnProperty("value")?t.value:o,i=r.filter('[value="'+o+'"]'),s=i.length?i.text():"",i.length?(_.isObject(t)&&t.hasOwnProperty("label")||s===o)&&s===t.label||(i.text(_.isObject(t)&&t.hasOwnProperty("label")?t.label:o),c||(c=!0)):(n='<option value="'+o+'">',n+=_.isObject(t)&&t.hasOwnProperty("label")?t.label:o,n+="</option>",e.append(n))}),r.each(function(){var e,r=t(this),i=r.val()
...
var r,o,n,i,s,c=this,u=this.$el.find(this.select2_selector),a=u.filter('[data-type="operators"]'),l=a.find("option"),d=u.filter('[data-type="values"]'),p=d.find("option"),b=this.views.parent.model.get("columns")
this.$select2=u,u.each(function(){var u,h=t(this),y={},f=h.data("select2"),g=[],m=[],q=h.data("select-type"),v=h.data("type"),w=h.val(),B=c.getMeta(),k=h.prop("multiple"),C=h.data("selected-options")
if(!e.length||-1!==e.indexOf(v)){if(c.options.columns[v]&&c.options.columns[v].select2&&c.options.columns[v].select2.tags){if(y.tags=!0,!f)switch(w=B.values,o=B.parameters&&"string"==typeof B.parameters&&conductor_query_builder.clauses[q]&&conductor_query_builder.clauses[q].parameters?conductor_query_builder.clauses[q].parameters:!1,o=o&&"string"==typeof B.parameters&&o[B.parameters]&&o[B.parameters].field?o[B.parameters].field:"string"==typeof B.parameters?B.parameters:!1,B.parameters&&!o&&(r=B.parameters.slice(0),o=r&&conductor_query_builder.clauses[q]&&conductor_query_builder.clauses[q].parameters&&conductor_query_builder.clauses[q].parameters?conductor_query_builder.clauses[q].parameters:!1,o=o&&o[r]&&o[r].field?o[r].field:!1),v){case"values":n=c.views.parent.getParameterData(w,r?r:B.parameters,o,q),i=c.views.parent.getOperators(n),s=c.views.parent.getValues(r?r:B.parameters,q),i&&i.length&&a.length&&(c.views.parent.updateOperatorsSelect(a,l,B.operators&&"string"==typeof B.operators?B.operators:B.operators.slice(0),i,!0),b&&b.values&&s&&(c.views.parent.updateValuesSelect(d,p,w,s,!0),p=d.find("option")),w&&w.length&&!_.isEqual(w,s)&&_.each(w,function(e){p.filter('[value="'+e+'"]').length||(y.hasOwnProperty("data")||(y.data=[]),y.data.push(e))}))}y.tokenSeparators=c.options.columns[v].select2.tags}switch(c.options.shortcode&&(y.dropdownParent=t("#TB_ajaxContent")),conductor_query_builder.select2.language&&(y.language=conductor_query_builder.select2.language),conductor_query_builder.select2.dir&&(y.dir=conductor_query_builder.select2.dir),f&&f.isOpen()&&h.select2("close"),h.conductor_qb_select2(y),v){case"parameters":a.prop("disabled")&&B.parameters&&a.prop("disabled",!1),o=B.parameters&&"string"==typeof B.parameters&&conductor_query_builder.clauses[q]&&conductor_query_builder.clauses[q].parameters?conductor_query_builder.clauses[q].parameters:!1,o=o&&"string"==typeof B.parameters&&o[B.parameters]&&o[B.parameters].field?o[B.parameters].field:"string"==typeof B.parameters?B.parameters:!1,B.parameters&&!o&&(r=B.parameters.slice(0),o=r&&conductor_query_builder.clauses[q]&&conductor_query_builder.clauses[q].parameters&&conductor_query_builder.clauses[q].parameters?conductor_query_builder.clauses[q].parameters:!1,o=o&&o[r]&&o[r].field?o[r].field:!1),n=n?n:c.views.parent.getParameterData(w,r?r:B.parameters,o,q),i=!i&&n?c.views.parent.getOperators(n):i,i&&i.length&&a.length&&c.views.parent.updateOperatorsSelect(a,l,B.operators?B.operators&&"string"==typeof B.operators?B.operators:B.operators.slice(0):"",i,!0)
break
case"operators":b&&b.values&&(d.prop("disabled")&&conductor_query_builder.operators[w]&&("string"==typeof conductor_query_builder.operators[w]||conductor_query_builder.operators[w].type&&"bool"!==conductor_query_builder.operators[w].type)?d.prop("disabled",!1):!d.prop("disabled")&&conductor_query_builder.operators[w]&&"string"!=typeof conductor_query_builder.operators[w]&&conductor_query_builder.operators[w].type&&"bool"===conductor_query_builder.operators[w].type&&d.prop("disabled",!0))
break
case"values":B.values&&(w=h.val(),_.isEqual(w,B.values)||(h.val(B.values).trigger("change"),w=h.val())),k&&C&&c.updateSelect2Options(h)}f=h.data("select2"),u=f.$element.attr("class").split(/\s+/),u=u.map(function(e){return-1===e.indexOf("select2")?e:""}).filter(function(e){return e}),_.each(u,function(e){g.push(e+"-select2"),g.push(e+"-select2-container"),m.push(e+"-select2"),m.push(e+"-select2-results")}),g=g.join(" "),m=m.join(" "),f.$container.addClass(g),f.$results.addClass(m),c.setMetaValue(v,w)}})},maybeEnableActionButtons:function(){var e=this.$el.find(this.select2_selector)
e.each(function(){var e=t(this),r=e.val(),o=e.data("toggle-action-buttons")
return o&&r&&r.length?(c.trigger("conductor-qb-enable-action-buttons"),_.each(conductor_query_builder.Backbone.instances.views.clause_action_buttons,function(e){e.trigger("conductor-qb-enable-action-buttons")}),!1):void 0})},maybeSetModelID:function(e){e=e||!1
...
return this.destroySelect2(),a.remove(this.model),t=e.Backbone.View.prototype.remove.apply(this,arguments),r=o.map(function(e){return e.cid}).indexOf(this.cid),-1!==r&&o.splice(r,1),-1!==c&&-1!==u&&conductor_query_builder.meta[n][c]&&conductor_query_builder.meta[n][c]&&conductor_query_builder.meta[n][c][u]&&conductor_query_builder.meta[n][c].splice(u,1),i.options.flags.removing||_.each(i.views.get(l),function(e){-1!==e.options.count&&(e.options.parent.count!==c&&e.options.parent.count>c||e.options.count>u)&&e.render(!0)}),t},select2Change:function(e){var r=t(e.currentTarget),o=(r.data("select2"),r.val()),n=r.data("type"),i=r.data("toggle-action-buttons")
i&&(o&&o.length?(c.trigger("conductor-qb-enable-action-buttons"),_.each(conductor_query_builder.Backbone.instances.views.clause_action_buttons,function(e){e.trigger("conductor-qb-enable-action-buttons")})):(c.trigger("conductor-qb-disable-action-buttons"),_.each(conductor_query_builder.Backbone.instances.views.clause_action_buttons,function(e){e.trigger("conductor-qb-disable-action-buttons")}))),this.setMetaValue(n,o),this.views.parent.select2Change(e,this)},select2SelectUnselect:function(e){var r=t(e.currentTarget),o=-1,n=r.prop("multiple"),i=r.data("selected-options")||[],s=r.data("type"),c=e.params.data.id
if("values"===s&&n){switch(e.type){case"select2:select":i.push(c)
break
case"select2:unselect":o=i.indexOf(c),-1!==o&&i.splice(o,1)}r.data("selected",i).attr("selected-options",JSON.stringify(i)),this.updateSelect2Options(r)}},select2Close:function(e){var r=t(e.currentTarget)
...
r[e]=t,this.model.set("meta",r),this.options.meta=r,-1!==i&&-1!==s&&(conductor_query_builder.meta[o][i]||(conductor_query_builder.meta[o][i]=[]),conductor_query_builder.meta[o][i][s]||(conductor_query_builder.meta[o][i][s]=_.clone(conductor_query_builder.Backbone.defaults.meta)),conductor_query_builder.meta[o][i][s][e]&&_.isEqual(conductor_query_builder.meta[o][i][s][e],t)||(conductor_query_builder.meta[o][i][s][e]=t))},getCurrentCount:function(e){e=e||!1
var t
...
i=i.filter('[data-type="'+r.data("type")+'"]'),e.preventDefault(),o.removeClass("nav-tab-active"),i.removeClass("active"),r.addClass("nav-tab-active"),t(s).addClass("active")}),conductor_query_builder.flags.is_query_builder_post_type&&conductor_query_builder.fn.query_builder.init(),u.on("click.conductor-qb",function(e){r.addClass("conductor-shortcode-ui-visible"),p?(conductor_query_builder.fn.shortcode.reset(),h.render(),conductor_query_builder.fn.query_builder.reset(),s.initialize(),s.trigger("conductor-qb-shortcode-reset"),s.$el.trigger("conductor-qb-shortcode-reset")):(conductor_query_builder.fn.shortcode.init(),conductor_query_builder.fn.query_builder.init(!0),s.trigger("conductor-qb-shortcode-init"),s.$el.trigger("conductor-qb-shortcode-init")),tb_show(conductor_query_builder.l10n.shortcode.title,"#TB_inline?inlineId=conductor-qb-shortcode-wrapper-container&width=753&height=480",!1),"advanced"===window.getUserSetting(conductor_query_builder.user.settings["query-builder"].mode.name)&&setTimeout(function(){_.each(conductor_query_builder.Backbone.instances.views.clause_action_buttons,function(e){e.$el.find(e.action_button_selector).removeClass("hide hidden conductor-qb-hide conductor-qb-hidden")})},1)}),r.on("thickbox:removed",function(){r.hasClass("conductor-shortcode-ui-visible")&&(conductor_query_builder.fn.shortcode.reset(),conductor_query_builder.fn.query_builder.reset(),p.$el.find(".conductor-qb-tabs .nav-tab:first-child").trigger("click"),conductor_query_builder.fn.conductor.widget.reset(),setTimeout(function(){r.removeClass("conductor-shortcode-ui-visible")},1))}),o.on("keydown.conductor-qb",".select2-search__field, .select2-search--inline",function(e){r.hasClass("conductor-shortcode-ui-visible")&&27===e.which&&e.stopImmediatePropagation()}),o.on("keydown.conductor-qb",function(e){r.hasClass("conductor-shortcode-ui-visible")&&27===e.which&&(a.isMetaEmpty()&&p.isSimpleQueryArgsEmpty()||window.confirm(conductor_query_builder.l10n.shortcode.confirm)||e.stopImmediatePropagation())}),e=new MutationObserver(function(e){r.hasClass("conductor-shortcode-ui-visible")&&_.each(e,function(e){e.addedNodes&&e.addedNodes.length&&_.each(e.addedNodes,function(e){if("TB_window"===e.id){var o=t("#TB_overlay, #TB_closeWindowButton")
