...
e.prop("disabled",!1)}}),conductor_query_builder.Backbone.Views.Shortcode_Insert=e.Backbone.View.extend({id:"conductor-qb-shortcode-insert-inner",el_selector:"#conductor-qb-shortcode-insert",template:e.template("conductor-qb-shortcode-query-builder-insert"),initialize:function(e){_.bindAll(this,"render")},render:function(){return e.Backbone.View.prototype.render.apply(this,arguments),this}}),conductor_query_builder.Backbone.Views.Shortcode_Create_Title=e.Backbone.View.extend({id:"conductor-qb-shortcode-create-title-inner",el_selector:"#conductor-qb-shortcode-create-title-content",template:e.template("conductor-qb-shortcode-query-builder-create-title"),initialize:function(e){_.bindAll(this,"render")},render:function(){return e.Backbone.View.prototype.render.apply(this,arguments),this}}),t(function(){var e,r=t("body"),i=t(document),n=t(".conductor-qb-tabs a"),s=t(".conductor-qb-add-shortcode")
